...
@"4#.26" = private unnamed_addr constant [4 x i8] c"2^4\00", align 1
@"4#.27" = private unnamed_addr constant [4 x i8] c"3^4\00", align 1
@"4#.28" = private unnamed_addr constant [4 x i8] c"4^4\00", align 1
@"4#.29" = private unnamed_addr constant [4 x i8] c"5^4\00", align 1
@"4#.30" = private unnamed_addr constant [4 x i8] c"1^5\00", align 1
@"4#.31" = private unnamed_addr constant [4 x i8] c"2^5\00", align 1
@"4#.32" = private unnamed_addr constant [4 x i8] c"3^5\00", align 1
@"4#.33" = private unnamed_addr constant [4 x i8] c"4^5\00", align 1
@"4#.34" = private unnamed_addr constant [4 x i8] c"5^5\00", align 1
...
entry:
  ...
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.30", i32 0, i32 0), i8** %13
  %14 = getelementptr i8*, i8** %12, i32 1
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.31", i32 0, i32 0), i8** %14
  %15 = getelementptr i8*, i8** %12, i32 2
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.32", i32 0, i32 0), i8** %15
  %16 = getelementptr i8*, i8** %12, i32 3
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.33", i32 0, i32 0), i8** %16
  %17 = getelementptr i8*, i8** %12, i32 4
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.34", i32 0, i32 0), i8** %17
  ...
  %track_29 = load { i32*, i8**, i32, i32 }, { i32*, i8**, i32, i32 }* %track_2
  %generate_music_result10 = call i32 @generate_music({ i32*, i8**, i32, i32 } %track_29)
  ret i32 0
}
