...
entry:
  %b = alloca double
  %a = alloca double
  store double 1.100000e+00, double* %a
  store double 2.230000e+00, double* %b
  ...
  %printf3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.1, i32 0, i32 0), double %b2)
  ret i32 0
}
