...
@"4#.6" = private unnamed_addr constant [4 x i8] c"4^4\00", align 1
@"4#.7" = private unnamed_addr constant [4 x i8] c"1#7\00", align 1
@"4#.8" = private unnamed_addr constant [4 x i8] c"2b3\00", align 1
...
entry:
  ...
  %b = alloca i8*
  %c = alloca i8*
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.6", i32 0, i32 0), i8** %a
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.7", i32 0, i32 0), i8** %b
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.8", i32 0, i32 0), i8** %c
  %a1 = load i8*, i8** %a
  %pitchtoint = call i32 (i8*, ...) @pitch_to_int(i8* %a1)
  store i32 %pitchtoint, i32* %a_1
  %b2 = load i8*, i8** %b
  %pitchtoint3 = call i32 (i8*, ...) @pitch_to_int(i8* %b2)
  store i32 %pitchtoint3, i32* %b_1
  %c4 = load i8*, i8** %c
  %pitchtoint5 = call i32 (i8*, ...) @pitch_to_int(i8* %c4)
  store i32 %pitchtoint5, i32* %c_1
  %a_16 = load i32, i32* %a_1
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.4, i32 0, i32 0), i32 %a_16)
  %b_17 = load i32, i32* %b_1
  %printf8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.4, i32 0, i32 0), i32 %b_17)
  %c_19 = load i32, i32* %c_1
  %printf10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.4, i32 0, i32 0), i32 %c_19)
  ret i32 0
}
