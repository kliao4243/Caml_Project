...
@"123.6" = private unnamed_addr constant [12 x i8] c"Hello World\00", align 1
...
entry:
  %a = alloca { i8*, i32 }
  %struct.ptr = getelementptr inbounds { i8*, i32 }, { i8*, i32 }* %a, i32 0, i32 1
  store i32 1, i32* %struct.ptr
  %struct.ptr1 = getelementptr inbounds { i8*, i32 }, { i8*, i32 }* %a, i32 0, i32 0
  store i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"123.6", i32 0, i32 0), i8** %struct.ptr1
  %struct.ptr2 = getelementptr inbounds { i8*, i32 }, { i8*, i32 }* %a, i32 0, i32 1
  %struct.val.test = load i32, i32* %struct.ptr2
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.4, i32 0, i32 0), i32 %struct.val.test)
  %struct.ptr3 = getelementptr inbounds { i8*, i32 }, { i8*, i32 }* %a, i32 0, i32 0
  %struct.val.test2 = load i8*, i8** %struct.ptr3
  %prints = call i32 (i8*, ...) @puts(i8* %struct.val.test2)
  ret i32 0
}
