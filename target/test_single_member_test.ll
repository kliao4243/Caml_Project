...
entry:
  %a = alloca { i32 }
  %struct.ptr = getelementptr inbounds { i32 }, { i32 }* %a, i32 0, i32 0
  store i32 1, i32* %struct.ptr
  %struct.ptr1 = getelementptr inbounds { i32 }, { i32 }* %a, i32 0, i32 0
  %struct.val.test = load i32, i32* %struct.ptr1
