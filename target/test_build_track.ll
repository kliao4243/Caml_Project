...
@"4#.6" = private unnamed_addr constant [4 x i8] c"4b4\00", align 1
...
entry:
  ...
  store i32 4, i32* %2
  %malloccall1 = tail call i8* @malloc(i32 mul (i32 ptrtoint (i1** getelementptr (i1*, i1** null, i32 1) to i32), i32 2))
  ...
  %build_track_result = call { i32*, i8**, i32, i32 } @build_track(i32 1, i32 2, i8** %3, i32* %0)
  store { i32*, i8**, i32, i32 } %build_track_result, { i32*, i8**, i32, i32 }* %t
  %struct.ptr = getelementptr inbounds { i32*, i8**, i32, i32 }, { i32*, i8**, i32, i32 }* %t, i32 0, i32 2
  %struct.val.size = load i32, i32* %struct.ptr
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.4, i32 0, i32 0), i32 %struct.val.size)
  %struct.ptr2 = getelementptr inbounds { i32*, i8**, i32, i32 }, { i32*, i8**, i32, i32 }* %t, i32 0, i32 3
  %struct.val.instrument = load i32, i32* %struct.ptr2
  %printf3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.4, i32 0, i32 0), i32 %struct.val.instrument)
  %struct.ptr4 = getelementptr inbounds { i32*, i8**, i32, i32 }, { i32*, i8**, i32, i32 }* %t, i32 0, i32 1
  %struct.val.melody = load i8**, i8*** %struct.ptr4
  %6 = getelementptr i8*, i8** %struct.val.melody, i32 0
  %7 = load i8*, i8** %6
  %prints = call i32 (i8*, ...) @puts(i8* %7)
  %struct.ptr5 = getelementptr inbounds { i32*, i8**, i32, i32 }, { i32*, i8**, i32, i32 }* %t, i32 0, i32 0
  %struct.val.rhythm = load i32*, i32** %struct.ptr5
  %8 = getelementptr i32, i32* %struct.val.rhythm, i32 0
  %9 = load i32, i32* %8
  %printf6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.4, i32 0, i32 0), i32 %9)
  %struct.ptr7 = getelementptr inbounds { i32*, i8**, i32, i32 }, { i32*, i8**, i32, i32 }* %t, i32 0, i32 1
  %struct.val.melody8 = load i8**, i8*** %struct.ptr7
  %10 = getelementptr i8*, i8** %struct.val.melody8, i32 1
  %11 = load i8*, i8** %10
  %prints9 = call i32 (i8*, ...) @puts(i8* %11)
  %struct.ptr10 = getelementptr inbounds { i32*, i8**, i32, i32 }, { i32*, i8**, i32, i32 }* %t, i32 0, i32 0
  %struct.val.rhythm11 = load i32*, i32** %struct.ptr10
  %12 = getelementptr i32, i32* %struct.val.rhythm11, i32 1
  %13 = load i32, i32* %12
  %printf12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.4, i32 0, i32 0), i32 %13)
  ret i32 0
}
