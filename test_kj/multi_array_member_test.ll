...
entry:
  ...
  %struct.ptr = getelementptr inbounds { i32*, i8** }, { i32*, i8** }* %a, i32 0, i32 1
  ...
  store i32 3, i32* %6
  %struct.ptr2 = getelementptr inbounds { i32*, i8** }, { i32*, i8** }* %a, i32 0, i32 0
  store i32* %3, i32** %struct.ptr2
  %struct.ptr3 = getelementptr inbounds { i32*, i8** }, { i32*, i8** }* %a, i32 0, i32 1
  %struct.val.test = load i8**, i8*** %struct.ptr3
  %7 = getelementptr i8*, i8** %struct.val.test, i32 0
  %8 = load i8*, i8** %7
  %prints = call i32 (i8*, ...) @puts(i8* %8)
  %struct.ptr4 = getelementptr inbounds { i32*, i8** }, { i32*, i8** }* %a, i32 0, i32 0
  %struct.val.test2 = load i32*, i32** %struct.ptr4
  %9 = getelementptr i32, i32* %struct.val.test2, i32 0
  %10 = load i32, i32* %9
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.4, i32 0, i32 0), i32 %10)
  ret i32 0
}
