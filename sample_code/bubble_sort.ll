...
@"123" = private unnamed_addr constant [15 x i8] c"original array\00", align 1
@"123.2" = private unnamed_addr constant [13 x i8] c"sorted array\00", align 1
...
entry:
  ...
  store i32* %0, i32** %Arr
  %prints = call i32 (i8*, ...) @puts(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @"123", i32 0, i32 0))
  store i32 0, i32* %i
  br label %while

while:                                            ; preds = %while_body, %entry
  %i10 = load i32, i32* %i
  %tmp11 = icmp slt i32 %i10, 7
  br i1 %tmp11, label %while_body, label %merge

while_body:                                       ; preds = %while
  %Arr7 = load i32*, i32** %Arr
  %i8 = load i32, i32* %i
  %8 = getelementptr i32, i32* %Arr7, i32 %i8
  %9 = load i32, i32* %8
...
merge:                                            ; preds = %while
  ...
  %bubble_sort_result = call i32* @bubble_sort(i32* %Arr12, i32 7)
  store i32* %bubble_sort_result, i32** %sorted
  %prints13 = call i32 (i8*, ...) @puts(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @"123.2", i32 0, i32 0))
  store i32 0, i32* %i
  br label %while14

while14:                                          ; preds = %while_body15, %merge
  %i21 = load i32, i32* %i
  %tmp22 = icmp slt i32 %i21, 7
  br i1 %tmp22, label %while_body15, label %merge23

while_body15:                                     ; preds = %while14
  %sorted16 = load i32*, i32** %sorted
  %i17 = load i32, i32* %i
  %10 = getelementptr i32, i32* %sorted16, i32 %i17
  %11 = load i32, i32* %10
  %printf18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt, i32 0, i32 0), i32 %11)
  %i19 = load i32, i32* %i
  %tmp20 = add i32 %i19, 1
  store i32 %tmp20, i32* %i
  br label %while14

merge23:                                          ; preds = %while14
  ret i32 0
}
