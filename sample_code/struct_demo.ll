...
@"4#.6" = private unnamed_addr constant [4 x i8] c"3^5\00", align 1
@"4#.7" = private unnamed_addr constant [4 x i8] c"2#5\00", align 1
@"4#.8" = private unnamed_addr constant [4 x i8] c"3^5\00", align 1
@"4#.9" = private unnamed_addr constant [4 x i8] c"2#5\00", align 1
@"4#.10" = private unnamed_addr constant [4 x i8] c"3^5\00", align 1
@"4#.11" = private unnamed_addr constant [4 x i8] c"7^4\00", align 1
@"4#.12" = private unnamed_addr constant [4 x i8] c"2^5\00", align 1
@"4#.13" = private unnamed_addr constant [4 x i8] c"1^5\00", align 1
@"4#.14" = private unnamed_addr constant [4 x i8] c"6^4\00", align 1
@"4#.15" = private unnamed_addr constant [4 x i8] c"1^6\00", align 1
@"4#.16" = private unnamed_addr constant [4 x i8] c"2^6\00", align 1
@"4#.17" = private unnamed_addr constant [4 x i8] c"2#6\00", align 1
@"4#.18" = private unnamed_addr constant [4 x i8] c"3^6\00", align 1
@"4#.19" = private unnamed_addr constant [4 x i8] c"1^6\00", align 1
@"4#.20" = private unnamed_addr constant [4 x i8] c"2^6\00", align 1
@"4#.21" = private unnamed_addr constant [4 x i8] c"3^6\00", align 1
@"4#.22" = private unnamed_addr constant [4 x i8] c"7^5\00", align 1
@"4#.23" = private unnamed_addr constant [4 x i8] c"2^6\00", align 1
@"4#.24" = private unnamed_addr constant [4 x i8] c"1^6\00", align 1
@"123.25" = private unnamed_addr constant [10 x i8] c"For Alice\00", align 1
@"123.26" = private unnamed_addr constant [12 x i8] c"Entertainer\00", align 1
...
define i32 @main() {
entry:
  %May11th = alloca { i32, i32*, i8**, i8* }
  %May12th = alloca { i32, i32*, i8**, i8* }
  %my_choice = alloca { i32*, i8**, i32, i32 }
  %malloccall = tail call i8* @malloc(i32 mul (i32 ptrtoint (i1** getelementptr (i1*, i1** null, i32 1) to i32), i32 9))
  ...
  %struct.ptr = getelementptr inbounds { i32, i32*, i8**, i8* }, { i32, i32*, i8**, i8* }* %May11th, i32 0, i32 2
  store i8** %0, i8*** %struct.ptr
  %malloccall1 = tail call i8* @malloc(i32 mul (i32 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i32), i32 9))
  %10 = bitcast i8* %malloccall1 to i32*
  ...
  store i32 16, i32* %15
  %16 = getelementptr i32, i32* %10, i32 5
  store i32 16, i32* %16
  %17 = getelementptr i32, i32* %10, i32 6
  store i32 16, i32* %17
  %18 = getelementptr i32, i32* %10, i32 7
  store i32 16, i32* %18
  %19 = getelementptr i32, i32* %10, i32 8
  store i32 8, i32* %19
  %struct.ptr2 = getelementptr inbounds { i32, i32*, i8**, i8* }, { i32, i32*, i8**, i8* }* %May11th, i32 0, i32 1
  store i32* %10, i32** %struct.ptr2
  %struct.ptr3 = getelementptr inbounds { i32, i32*, i8**, i8* }, { i32, i32*, i8**, i8* }* %May11th, i32 0, i32 0
  store i32 1, i32* %struct.ptr3
  %malloccall4 = tail call i8* @malloc(i32 mul (i32 ptrtoint (i1** getelementptr (i1*, i1** null, i32 1) to i32), i32 10))
  %20 = bitcast i8* %malloccall4 to i8**
  %21 = getelementptr i8*, i8** %20, i32 0
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.15", i32 0, i32 0), i8** %21
  %22 = getelementptr i8*, i8** %20, i32 1
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.16", i32 0, i32 0), i8** %22
  %23 = getelementptr i8*, i8** %20, i32 2
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.17", i32 0, i32 0), i8** %23
  %24 = getelementptr i8*, i8** %20, i32 3
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.18", i32 0, i32 0), i8** %24
  %25 = getelementptr i8*, i8** %20, i32 4
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.19", i32 0, i32 0), i8** %25
  %26 = getelementptr i8*, i8** %20, i32 5
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.20", i32 0, i32 0), i8** %26
  %27 = getelementptr i8*, i8** %20, i32 6
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.21", i32 0, i32 0), i8** %27
  %28 = getelementptr i8*, i8** %20, i32 7
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.22", i32 0, i32 0), i8** %28
  %29 = getelementptr i8*, i8** %20, i32 8
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.23", i32 0, i32 0), i8** %29
  %30 = getelementptr i8*, i8** %20, i32 9
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.24", i32 0, i32 0), i8** %30
  %struct.ptr5 = getelementptr inbounds { i32, i32*, i8**, i8* }, { i32, i32*, i8**, i8* }* %May12th, i32 0, i32 2
  store i8** %20, i8*** %struct.ptr5
  %malloccall6 = tail call i8* @malloc(i32 mul (i32 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i32), i32 10))
  %31 = bitcast i8* %malloccall6 to i32*
  %32 = getelementptr i32, i32* %31, i32 0
  store i32 16, i32* %32
  %33 = getelementptr i32, i32* %31, i32 1
  store i32 16, i32* %33
  %34 = getelementptr i32, i32* %31, i32 2
  store i32 16, i32* %34
  %35 = getelementptr i32, i32* %31, i32 3
  store i32 16, i32* %35
  %36 = getelementptr i32, i32* %31, i32 4
  store i32 16, i32* %36
  %37 = getelementptr i32, i32* %31, i32 5
  store i32 16, i32* %37
  %38 = getelementptr i32, i32* %31, i32 6
  store i32 8, i32* %38
  %39 = getelementptr i32, i32* %31, i32 7
  store i32 16, i32* %39
  %40 = getelementptr i32, i32* %31, i32 8
  store i32 8, i32* %40
  %41 = getelementptr i32, i32* %31, i32 9
  store i32 4, i32* %41
  %struct.ptr7 = getelementptr inbounds { i32, i32*, i8**, i8* }, { i32, i32*, i8**, i8* }* %May12th, i32 0, i32 1
  store i32* %31, i32** %struct.ptr7
  %struct.ptr8 = getelementptr inbounds { i32, i32*, i8**, i8* }, { i32, i32*, i8**, i8* }* %May12th, i32 0, i32 0
  store i32 2, i32* %struct.ptr8
  %struct.ptr9 = getelementptr inbounds { i32, i32*, i8**, i8* }, { i32, i32*, i8**, i8* }* %May11th, i32 0, i32 3
  store i8* getelementptr inbounds ([10 x i8], [10 x i8]* @"123.25", i32 0, i32 0), i8** %struct.ptr9
  %struct.ptr10 = getelementptr inbounds { i32, i32*, i8**, i8* }, { i32, i32*, i8**, i8* }* %May12th, i32 0, i32 3
  store i8* getelementptr inbounds ([12 x i8], [12 x i8]* @"123.26", i32 0, i32 0), i8** %struct.ptr10
  %struct.ptr11 = getelementptr inbounds { i32, i32*, i8**, i8* }, { i32, i32*, i8**, i8* }* %May12th, i32 0, i32 0
  %struct.val.rating = load i32, i32* %struct.ptr11
  %struct.ptr12 = getelementptr inbounds { i32, i32*, i8**, i8* }, { i32, i32*, i8**, i8* }* %May11th, i32 0, i32 0
  %struct.val.rating13 = load i32, i32* %struct.ptr12
  %tmp = icmp slt i32 %struct.val.rating, %struct.val.rating13
  br i1 %tmp, label %then, label %else

merge:                                            ; preds = %else, %then
  %my_choice21 = load { i32*, i8**, i32, i32 }, { i32*, i8**, i32, i32 }* %my_choice
  call void @generate_music({ i32*, i8**, i32, i32 } %my_choice21)
  ret i32 0

then:                                             ; preds = %entry
  %struct.ptr14 = getelementptr inbounds { i32, i32*, i8**, i8* }, { i32, i32*, i8**, i8* }* %May11th, i32 0, i32 1
  %struct.val.rhythm = load i32*, i32** %struct.ptr14
  %struct.ptr15 = getelementptr inbounds { i32, i32*, i8**, i8* }, { i32, i32*, i8**, i8* }* %May11th, i32 0, i32 2
  %struct.val.melody = load i8**, i8*** %struct.ptr15
  %build_track_result = call { i32*, i8**, i32, i32 } @build_track(i32 1, i32 9, i8** %struct.val.melody, i32* %struct.val.rhythm)
  store { i32*, i8**, i32, i32 } %build_track_result, { i32*, i8**, i32, i32 }* %my_choice
  br label %merge

else:                                             ; preds = %entry
  %struct.ptr16 = getelementptr inbounds { i32, i32*, i8**, i8* }, { i32, i32*, i8**, i8* }* %May12th, i32 0, i32 1
  %struct.val.rhythm17 = load i32*, i32** %struct.ptr16
  %struct.ptr18 = getelementptr inbounds { i32, i32*, i8**, i8* }, { i32, i32*, i8**, i8* }* %May12th, i32 0, i32 2
  %struct.val.melody19 = load i8**, i8*** %struct.ptr18
  %build_track_result20 = call { i32*, i8**, i32, i32 } @build_track(i32 1, i32 10, i8** %struct.val.melody19, i32* %struct.val.rhythm17)
  store { i32*, i8**, i32, i32 } %build_track_result20, { i32*, i8**, i32, i32 }* %my_choice
  br label %merge
}
