...
@"4#.7" = private unnamed_addr constant [4 x i8] c"1^4\00", align 1
@"4#.8" = private unnamed_addr constant [4 x i8] c"5^4\00", align 1
@"4#.9" = private unnamed_addr constant [4 x i8] c"5^4\00", align 1
@"4#.10" = private unnamed_addr constant [4 x i8] c"6^4\00", align 1
@"4#.11" = private unnamed_addr constant [4 x i8] c"6^4\00", align 1
@"4#.12" = private unnamed_addr constant [4 x i8] c"5^4\00", align 1
@"4#.13" = private unnamed_addr constant [4 x i8] c"4^4\00", align 1
@"4#.14" = private unnamed_addr constant [4 x i8] c"4^4\00", align 1
@"4#.15" = private unnamed_addr constant [4 x i8] c"3^4\00", align 1
@"4#.16" = private unnamed_addr constant [4 x i8] c"3^4\00", align 1
@"4#.17" = private unnamed_addr constant [4 x i8] c"2^4\00", align 1
@"4#.18" = private unnamed_addr constant [4 x i8] c"2^4\00", align 1
@"4#.19" = private unnamed_addr constant [4 x i8] c"1^4\00", align 1
...
entry:
  ...
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.13", i32 0, i32 0), i8** %9
  %10 = getelementptr i8*, i8** %8, i32 1
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.14", i32 0, i32 0), i8** %10
  %11 = getelementptr i8*, i8** %8, i32 2
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.15", i32 0, i32 0), i8** %11
  %12 = getelementptr i8*, i8** %8, i32 3
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.16", i32 0, i32 0), i8** %12
  %13 = getelementptr i8*, i8** %8, i32 4
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.17", i32 0, i32 0), i8** %13
  %14 = getelementptr i8*, i8** %8, i32 5
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.18", i32 0, i32 0), i8** %14
  %15 = getelementptr i8*, i8** %8, i32 6
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"4#.19", i32 0, i32 0), i8** %15
  store i8** %8, i8*** %second
  %malloccall2 = tail call i8* @malloc(i32 mul (i32 ptrtoint (i1** getelementptr (i1*, i1** null, i32 1) to i32), i32 14))
  ...
  %second16 = load i8**, i8*** %second
  %31 = getelementptr i8*, i8** %second16, i32 0
  %temp17 = load i8*, i8** %31
  %32 = getelementptr i8*, i8** %16, i32 7
  store i8* %temp17, i8** %32
  %second18 = load i8**, i8*** %second
  %33 = getelementptr i8*, i8** %second18, i32 1
  %temp19 = load i8*, i8** %33
  %34 = getelementptr i8*, i8** %16, i32 8
  store i8* %temp19, i8** %34
  %second20 = load i8**, i8*** %second
  %35 = getelementptr i8*, i8** %second20, i32 2
  %temp21 = load i8*, i8** %35
  %36 = getelementptr i8*, i8** %16, i32 9
  store i8* %temp21, i8** %36
  %second22 = load i8**, i8*** %second
  %37 = getelementptr i8*, i8** %second22, i32 3
  %temp23 = load i8*, i8** %37
  %38 = getelementptr i8*, i8** %16, i32 10
  store i8* %temp23, i8** %38
  %second24 = load i8**, i8*** %second
  %39 = getelementptr i8*, i8** %second24, i32 4
  %temp25 = load i8*, i8** %39
  %40 = getelementptr i8*, i8** %16, i32 11
  store i8* %temp25, i8** %40
  %second26 = load i8**, i8*** %second
  %41 = getelementptr i8*, i8** %second26, i32 5
  %temp27 = load i8*, i8** %41
  %42 = getelementptr i8*, i8** %16, i32 12
  store i8* %temp27, i8** %42
  %second28 = load i8**, i8*** %second
  %43 = getelementptr i8*, i8** %second28, i32 6
  %temp29 = load i8*, i8** %43
  %44 = getelementptr i8*, i8** %16, i32 13
  store i8* %temp29, i8** %44
  store i8** %16, i8*** %total
  %malloccall30 = tail call i8* @malloc(i32 mul (i32 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i32), i32 14))
  %45 = bitcast i8* %malloccall30 to i32*
  %46 = getelementptr i32, i32* %45, i32 0
  store i32 4, i32* %46
  %47 = getelementptr i32, i32* %45, i32 1
  store i32 4, i32* %47
  %48 = getelementptr i32, i32* %45, i32 2
  store i32 4, i32* %48
  %49 = getelementptr i32, i32* %45, i32 3
  store i32 4, i32* %49
  %50 = getelementptr i32, i32* %45, i32 4
  store i32 4, i32* %50
  %51 = getelementptr i32, i32* %45, i32 5
  store i32 4, i32* %51
  %52 = getelementptr i32, i32* %45, i32 6
  store i32 2, i32* %52
  %53 = getelementptr i32, i32* %45, i32 7
  store i32 4, i32* %53
  %54 = getelementptr i32, i32* %45, i32 8
  store i32 4, i32* %54
  %55 = getelementptr i32, i32* %45, i32 9
  store i32 4, i32* %55
  %56 = getelementptr i32, i32* %45, i32 10
  store i32 4, i32* %56
  %57 = getelementptr i32, i32* %45, i32 11
  store i32 4, i32* %57
  %58 = getelementptr i32, i32* %45, i32 12
  store i32 4, i32* %58
  %59 = getelementptr i32, i32* %45, i32 13
  store i32 2, i32* %59
  store i32* %45, i32** %rhythm
  %rhythm31 = load i32*, i32** %rhythm
  %total32 = load i8**, i8*** %total
  %build_track_result = call { i32*, i8**, i32, i32 } @build_track(i32 1, i32 14, i8** %total32, i32* %rhythm31)
  store { i32*, i8**, i32, i32 } %build_track_result, { i32*, i8**, i32, i32 }* %track
  %track33 = load { i32*, i8**, i32, i32 }, { i32*, i8**, i32, i32 }* %track
  call void @generate_music({ i32*, i8**, i32, i32 } %track33)
  ret i32 0
}
